...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Portail officiel France Gems. Découvrez notre univers de pierres précieuses et de bijoux haut de gamme." },
      { name: "author", content: "France Gems" },
